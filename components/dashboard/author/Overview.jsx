...
import { getAnalyticsData } from '@/redux/features/slices/author/authorAnalyticsSlice'
import { useEffect } from 'react'
import { fetchAnalyticsData } from '@/redux/features/thunks/author/analyticsThunks'

const Overview = ({ token }) => {

    const response = useSelector(getAnalyticsData)

    const { published, draft, scheduled } = response?.analytics || {};
